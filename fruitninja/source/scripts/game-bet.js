...
define("scripts/game.js", function(exports){
	...
	exports.applyScore = function( score ){
			...
			else if(score >= (aposta*0.5)){volleyNum = 3;}
			else {volleyNum = 2;}
	};
...
define("scripts/layer.js", function(exports){
	var Player = require("scripts/lib/Player");
	var ucren = require("scripts/lib/ucren");
	...
	exports.getLayer = function( name ){
		...
		if( p = layers[name] ){
			...
			p = layers[name] = Player( layer, screenW, screenH );
			return p;
		}
	};
...
define("scripts/factory/fruit.js", function(exports){
	...
	exports.create = function( type, originX, originY, isHide, flameStart ){
		if( typeof type == "number" ) // ç¼ºçœ type
			isHide = originY,
			originY = originX,
		    originX = type,
		    type = getType();
...
define("scripts/lib/Player.js", function(exports){
	var Player;
	var window = {};
	/* ########## */
	(function() {
    ...
    var bi = function(b) {
            if (a.vml) {
                ...
                h.title = "Frutinhas Colour Picker";
    ...
    a.getRGB = bm(function(b) {
        ...
        if (k) {
            ...
            if (k[5]) {
                ...
                g = S(j[2]);
                j[2].slice(-1) == "%" && (g *= 2.55);
                (j[0].slice(-3) == "deg" || j[0].slice(-1) == "Â°") && (d /= 360);
    ...
    var bn = bm(function(a) {
        ...
        bF = function(a) {
            return function() {
                throw new Error("Frutinhas: you are calling to method â€œ" + a + "â€ of removed object")
            }
        };
    a.pathToRelative = bp;
    if (a.svg) {
        ...
        a[H] = function() {
            return "Your browser supports SVG.\nYou are running Frutinhas " + this.version
        };
        var bH = function(a, b) {
                var c = bG("path");
        ...
        k.clear = function() {
            ...
            (this.desc = bG("desc"))[l](g.createTextNode("Frutinhas"));
            a[l](this.desc);
    ...
    navigator.vendor == "maca Computer, Inc." && (ce && ce[1] < 4 || navigator.platform.slice(0, 2) == "iP") ? k.safari = function() {
    ...
    a.ninja = function() {
        i.was ? h.Player = i.is : delete Player;
        return a
    };
    a.el = bO;
    a.st = cC[e];
    i.was ? h.Player = a : Player = a
})();
	/* ########## */
	exports = Player;;
...
define("scripts/object/fps.js", function(exports){
	...
	exports.set = function(){
		...
		text = layer.createText( "default", '', 4, 470 ).attr( "fill", "#ccc" );
	};
...
define("scripts/object/logo.js", function(exports){
	...
	exports = displacement.create("images/logo.png?v=1.0", 320, 150, 17, -182, 17, 1, tween.exponential.co, 1e3);;
